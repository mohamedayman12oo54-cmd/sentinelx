  ...
  return (
    <div>
      <Topbar
        ...
        actions={
          <>
            {/* Compared against the Backend's real (uppercase) AlertStatus
                enum values — see CONTRACT-010/STATE-007. */}
            <button
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                {/* Badge's style tokens are lowercase; normalized here at the
                    display call site (CONTRACT-010/STATE-007). */}
